...
/**
 * Class that contains helper methods for the Review Lab (method
 * removePunctuation() was added from teacher code)
 **/
public class Review {
  ...
  static {
    try {
      Scanner input = new Scanner(new File("cleanSentiment.txt"));
